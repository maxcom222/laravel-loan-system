...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.saving',2)}} {{trans_choice('general.account',1)}}</h6>

            <div class="heading-elements">

            </div>
        </div>
        {!! Form::open(array('url' => url('saving/'.$saving->id.'/update'), 'method' => 'post', 'id' => 'savings_form',"enctype"=>"multipart/form-data", 'class' => 'form-horizontal')) !!}
        <div class="panel-body">
            <div class="form-group">
                {!! Form::label('borrower_id',trans_choice('general.borrower',1)." *",array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                    {!! Form::select('borrower_id',$borrowers,$saving->borrower_id, array('class' => ' select2 form-control', 'placeholder'=>"Select",'disabled'=>'','id'=>'borrower_id')) !!}
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::select('savings_product_id',$savings_products,$saving->savings_product_id, array('class' => 'select2 form-control','disabled'=>'','id'=>'savings_product_id')) !!}
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::text('date',$saving->date, array('class' => 'form-control date-picker', 'placeholder'=>"yyyy-mm-dd",'required'=>'required','id'=>'date')) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('notes',trans_choice('general.note',2),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                    {!! Form::textarea('notes',$saving->notes, array('class' => 'form-control', 'rows'=>'2',)) !!}
                </div>
            </div>
            ...
            <div class="form-group" id="chargesDiv">
                <div style="display: none;" id="saved_charges">
                    @foreach($saving->savings_product->charges as $key)
