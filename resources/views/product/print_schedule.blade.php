...
<div>
    ...
    <div style="width: 980px;height: 224px;margin-left: auto;margin-right: auto;border-top: solid thin rgba(2, 180, 209, 0.44);border-bottom: solid thin rgba(2, 180, 209, 0.44);padding: 20px;text-transform: capitalize">
        ...
        <div style="width: 300px;margin-right: 40px;float: left">
            <b>{{trans_choice('general.account',1)}} #</b><span class="pull-right">{{$account->id}}</span><br><br>
            <b>Start Date</b><span class="pull-right">{{$account->start_date}}</span><br><br>
            <b>End Date</b><span class="pull-right">{{$account->end_date}}</span><br><br>
            <b>{{trans_choice('general.repayment',1)}}</b><span class="pull-right"
                                                                style="">{{$account->repayment_cycle}}</span><br><br>
            <b>{{trans_choice('general.amount',1)}}</b><span class="pull-right"
                                                             style="">{{number_format($account->amount,2)}}</span><br><br>

        </div>
        <div style="width: 300px;float: left">
            <b>{{trans_choice('general.due',1)}}</b><span class="pull-right"
                                                          style="">{{number_format(\App\Helpers\GeneralHelper::account_amount_due($account->id),2)}}</span><br><br>
            <b>{{trans_choice('general.paid',1)}}</b><span class="pull-right"
                                                           style="">{{number_format(\App\Models\AccountPayment::where('account_id',$account->id)->sum('amount'),2)}}</span><br><br>
