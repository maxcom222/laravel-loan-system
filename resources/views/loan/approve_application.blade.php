...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.approve',1)}} {{trans_choice('general.application',1)}}</h6>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::select('loan_officer_id',$users,null, array('class' => ' select2 form-control', 'placeholder'=>"Select",'required'=>'required')) !!}
                </div>
                <div class="col-sm-4">
